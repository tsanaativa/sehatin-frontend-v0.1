      ...
      {isMini ? (
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <span className="bg-gray-light w-full md:max-w-[250px] lg:max-w-full">
        ...
        >
          ...
          <div className="w-full flex flex-col gap-1">
            <div className="flex justify-between items-center gap-2">
              <span className="bg-gray-light font-poppins font-medium text-dark max-w-[200px] line-clamp-1 md:max-w-[250px] lg:max-w-full md:text-lg">
                <span className="invisible">Doctor</span>
              </span>
