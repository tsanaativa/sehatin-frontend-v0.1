...
const MedsDetail = () => {
  return (
    <div className="flex flex-wrap md:flex-nowrap md:gap-x-4 md:px-20 md:pt-10 md:pb-20">
      <Image
        ...
        alt=""
      />
      <div className="px-4 py-6 sm:px-6 w-full md:pt-0">
        ...
        <div className="flex flex-col gap-y-4 mt-6">
          ...
          <div className="flex flex-col gap-y-1">
            ...
            <p className="text-xs text-dark-gray md:text-base">
              ...
              accompanied by flu symptoms such as fever, headache, and sneezing.
            </p>
          </div>
          <div className="flex flex-col gap-y-1">
            <span className="font-poppins font-semibold text-sm text-dark md:text-base">
